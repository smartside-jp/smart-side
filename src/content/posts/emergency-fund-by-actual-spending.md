...
「3-6 ヶ月分は確保しろ」とよく聞くけど、その『生活費』が自分にとって何なのかが分からない。今日はそういう人向けに書いていく。

結論を先に書くと、計算は単純で、**銀行・クレカの過去 1 年の出金平均**を取るだけ。それを基準に厚さを決める。読み終わるまで 5 分。電卓を出すかどうかは、その後で。
...
順番が逆で、標準テンプレに自分を当てはめるんじゃなく、**自分の数字から組み立てる**のが先。
...
理由はシンプルで、切り崩す前提でない額を投資に回しているから。リスク資産が一時的に下がっても、生活には影響が出ない構造になっている。これが「厚さの恩恵」の体感です。
