...
申請が拒否されたので Moffatt さんが裁判を起こしたところ、Air Canada は「**チャットボットは別法人で、会社は責任を負わない**」と抗弁。裁判所は一蹴して、差額812ドルの支払いを命じた。
...
データで見ると、GPT-4 でも事実主張の **3〜5%** は誤り、引用に至っては **約36%** が捏造という研究報告があります（複数論文）。「優秀なモデルなら安全」も成り立たない。
