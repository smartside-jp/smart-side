...
調べてみると、<mark>**経路は5つあって、しかも『学習』より具体的に怖い事件が実際に起きている**</mark> ことが分かりました。
...
<mark>**個人として気にすべきは、経路2（バグ・内部漏洩）が一番**</mark> ── これは<span class="text-red">自分の運用では完全には防げない</span>からです。

そして経路3（Share 機能の誤公開）は、**仕組みを知っていれば<span class="text-blue">自分で防げる</span>** タイプ。「共有」設定は触らないだけで回避できます。
