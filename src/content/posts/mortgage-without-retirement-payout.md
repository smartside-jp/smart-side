...
結論を先に言うと、<mark class="hi-pink">**【退職金が見込めない人ほど、iDeCo を退職金代わりに組む経済合理性が高い】**</mark>。住宅ローン完済は **「60 歳前 = iDeCo 受給開始前」** を設計ラインにする。8 分で整理する。

## 50 年ローン時代 ──<wbr> 借入時平均 44.5 歳の現実

まず数字で見てみる。

2024 年度フラット35 利用者の <mark>**借入時平均年齢は 44.5 歳**</mark>(2023 年:44.3 歳・2014 年:40.4 歳)。**10 年で <span class="text-red">4.1 歳上昇</span>** してる。
...
「リタイアまで引き出せない」「リタイア時に一括 or 分割で受給」「退職所得控除が使える」── <mark>**3 要素が完全に一致**</mark> してる。
...
2026 年 1 月から、退職金と iDeCo を **両方一時金で受け取る場合**、間隔が **<span class="text-red">10 年空いてないと退職所得控除が按分される</span>** ようになった(従来は 5 年)。これは **退職金あり世代に不利化** する改正。

つまり構造的に:**退職金が見込めない人ほど、iDeCo の節税効果が大きく出る**。これは社会保障の「制度のスキマ」を埋める設計、とも言える。

<figure class="my-10">
  <img
    src="/images/posts/mortgage-without-retirement-payout-comparison.png"
    alt="退職金 vs iDeCo 機能比較インフォグラフィック。受給時期・退職所得控除の使い方・2026年1月からの「10年ルール」改正・節税効果の差を視覚化。退職金が見込めない人ほど iDeCo の節税効果が大きく出る構造。"
    width="1672"
    height="941"
    loading="lazy"
    decoding="async"
  ...
  <figcaption class="text-center text-xs mt-3" style="color: var(--color-fg-muted);">
    退職金が見込めない世代ほど、iDeCo の節税効果が大きく出る
  </figcaption>
</figure>
...
だから設計は:<mark class="hi-pink">**【ローン完済 < 60 歳】**</mark>(= iDeCo 受給開始前)を絶対ラインにする。
...
これは <mark class="hi-blue">**消極的選択じゃなく、不確実な時代の自助の組み立て方**</mark>。機能で並べて整理してみると、退職金が見込めなくても、自分で「退職金的な何か」を作れる ── そう見えてくる。
