...
[1Password と 2段階認証で守るベースライン](/posts/1password-2fa-baseline) が **最初の2手**（パスワード管理 + 2段階認証）を扱ったので、こちらは **最後の1手**（データを失わない仕組み）を扱います。
...
![HDD 年間故障率1.57%・1年で64台に1台が壊れる](/images/posts/backup-3-2-1-chart-1-hdd.png)
...
![ランサムウェア被害件数の推移（日本2025年226件・米国前年比+149%）](/images/posts/backup-3-2-1-chart-2-ransom.png)
...
![スマホ容量超過時の対応（有料クラウド30.6% / PC移動26.4% / 外部SSD17.7%）](/images/posts/backup-3-2-1-chart-3-backup-rate.png)
...
- [1Password と 2段階認証で守るベースライン ─ 数百人の事故から逆算した最初の2手](/posts/1password-2fa-baseline) — 3点セットの最初の2手・本記事と兄弟
